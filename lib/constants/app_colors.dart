...
class AppColors {
  static const Color background = Color(0xFF1A2530); // Dark background
  static const Color primary = Color(0xFF3B82F6); // Highlighted blue
  static const Color lightBlue = Color(0xFF161f28); // Light blue
